...
Version  : 24.02.2
Release  : 61
URL      : https://download.kde.org/stable/release-service/24.02.2/src/kdeedu-data-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/kdeedu-data-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/kdeedu-data-24.02.2.tar.xz.sig
...
%setup -q -n kdeedu-data-24.02.2
cd %{_builddir}/kdeedu-data-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712936229
mkdir -p clr-build
pushd clr-build
