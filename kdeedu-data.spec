...
Version  : 23.08.3
Release  : 55
URL      : https://download.kde.org/stable/release-service/23.08.3/src/kdeedu-data-23.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/kdeedu-data-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/kdeedu-data-23.08.3.tar.xz.sig
...
%prep
%setup -q -n kdeedu-data-23.08.3
cd %{_builddir}/kdeedu-data-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699576930
mkdir -p clr-build
pushd clr-build
