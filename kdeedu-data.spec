...
Source0  : https://download.kde.org/stable/release-service/21.08.1/src/kdeedu-data-21.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.1/src/kdeedu-data-21.08.1.tar.xz.sig
...
%prep
%setup -q -n kdeedu-data-21.08.1
cd %{_builddir}/kdeedu-data-21.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630896135
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdeedu-data-21.08.1/COPYING %{buildroot}/usr/share/package-licenses/kdeedu-data/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
